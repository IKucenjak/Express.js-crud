...
class Company extends Model {
    ...
    static async paginated(options) {
        ...
        const paginatedCompanies = await Company.findAndCountAll(queryOptions);
    
        return {
            companies: paginatedCompanies.rows,
            total: paginatedCompanies.count,
            totalPages: Math.ceil(paginatedCompanies.count / limit),
        };
    }

    static async update(company_id, company_data) {
        const { handle, name, website, country } = company_data;
